-- ================================================================
-- Online Exam Bank Database Schema
-- Author: Thepthat Boonbumrung
-- Date: 2025-10-27
-- Description:
--   รองรับระบบ 2 role: Instructor, Student
--   มีการจัดการ Courses, Topics, Exams, Questions, Choices, Answers
--   ใช้ร่วมกับ API (JWT Authentication)
-- ================================================================
...
CREATE TABLE Users (
  ...
  Password VARCHAR(255) NOT NULL, -- ควรเก็บ bcrypt หรือ argon2 hash
  Department VARCHAR(100),
  Role ENUM('instructor', 'student') NOT NULL,
  StudentID VARCHAR(20) NULL,  -- ใช้เฉพาะ student
...
-- ----------------------------------------------------------------
-- 12. View: Student Exam Dashboard
-- ----------------------------------------------------------------
...
BEGIN
  ...
  SELECT SUM(Points) INTO v_total FROM Questions WHERE ExamID = v_examId;
  SELECT SUM(PointsEarned) INTO v_score FROM StudentAnswers WHERE AttemptID = inAttemptID;
...
-- ----------------------------------------------------------------
-- 14. Default Admin / Instructor Example
-- ----------------------------------------------------------------
